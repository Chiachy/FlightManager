package com.shanshan.flightmanager.ToolClassies;
    ...
    public List<ManagerOrderDatas> searchOrderDatas(String userId) {
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                managerOrderDatas.setFlight_number(cursor.getString(cursor.getColumnIndex("flight_number")));
...
//            values.put("id",managerOrderDatas.getId());
            ...
            values.put("flight_number", managerOrderDatas.getFlight_number());
