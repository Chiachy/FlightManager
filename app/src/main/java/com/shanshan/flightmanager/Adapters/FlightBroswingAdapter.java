...
public class FlightBroswingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private LayoutInflater mInflater;
    private Context mContext;
    public static List<ManagerFlightDatas> mDatas = new ArrayList<>();

    public FlightBroswingAdapter(Context context, List<ManagerFlightDatas> mDatas) {
