 ...
 */
public class FlightChooseSiteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FlightChooseSiteAdapter(Context context, List<ManagerFlightDatas> mDatas,
