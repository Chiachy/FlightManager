...
public class BeginningAnimationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataBaseModel mFlightDatabaseOpenHelper = DataBaseModel
                .getInstance(BeginningAnimationActivity.this);
        ...
        alphaAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                startActivity(new Intent(BeginningAnimationActivity.this, FlightChooseActivity.class));
                finish();
            }
    ...
    private void initFlightDatas4DB() {
        ...
        DataBaseModel db = DataBaseModel.getInstance(BeginningAnimationActivity.this);
        ...
        //Toast.makeText(BeginningAnimationActivity.this, "数据库生成完毕", Toast.LENGTH_LONG).show();
    }
}
