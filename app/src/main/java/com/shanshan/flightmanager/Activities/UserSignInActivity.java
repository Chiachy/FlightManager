...
public class UserSignInActivity extends Activity {
    ...
    public void initViews() {
        ...
        mClearAccountButton = (ImageButton) findViewById(R.id.manage_flight_update_clear_company_btn);
    ...
    private void attemptLogin() {
        ...
        if (email.equals(MANAGER_ACCOUNT) && password.equals(MANAGER_PASSWORD)){
            startActivity(new Intent(UserSignInActivity.this, ManagerUIActivity.class));
...
//    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            managerUserDatas = DataBaseModel.getInstance(UserSignInActivity.this).searchUser(mEmail);
            if (managerUserDatas.getId() == null) {
                return false;
            } else if (managerUserDatas.getPassword().equals(mPassword)) {
                UserDetailsActivity.id = mEmail;
                return true;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                finish();
                Toast.makeText(UserSignInActivity.this, "登入成功", Toast.LENGTH_LONG).show();
